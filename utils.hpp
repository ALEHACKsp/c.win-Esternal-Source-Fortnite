...
RGBA ESPColor = { 0, 255, 255, 255 };

namespace Settings {
	namespace Selection {
		bool bMouseAimbotEnabled = false,Prediction = false, bLineESPEnabled = false, bDistanceESP = false, bDrawFOV = false, bVisualName = false, bBox = false, outline = false, skel = false;
		int bBoxMode = false, showhead = false, distance, MaxSkeletonDrawDistance = 30, hitbox = false, EspDistance = 100, AimbotDistance = 50;
